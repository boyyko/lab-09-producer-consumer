...
#ifndef TEMPLATE_PRODUCE_HPP
#define TEMPLATE_PRODUCE_HPP
...
class downloader {
 public:
  downloader(unsigned poolsCount);
...
void Downloader::search_links(GumboNode* g_node) {
